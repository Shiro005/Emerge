...
const Stats = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Vastu Construction Services in Akola | Emerge Construction</title>
                <meta name="description" content="Expert Vastu-compliant construction services in Akola by Emerge Construction. Build your home or office with ancient Vastu principles for harmony, prosperity and positive energy." />
                <meta name="keywords" content="vastu construction akola, vastu compliant building akola, vastu shastra construction akola, emerge construction vastu, vastu architect akola, vastu consultant akola" />
                <link rel="canonical" href="https://emergeconstruction.in/vastu" />

                {/* Open Graph tags for better social sharing */}
                <meta property="og:title" content="Vastu Construction Services in Akola | Emerge Construction" />
                <meta property="og:description" content="Expert Vastu-compliant construction services in Akola by Emerge Construction. Build with ancient Vastu principles for harmony and prosperity." />
                <meta property="og:image" content="https://emergeconstruction.in/vastu-og-image.jpg" />
                <meta property="og:url" content="https://emergeconstruction.in/vastu" />
                <meta property="og:type" content="website" />

                {/* Specific schema for Vastu services */}
                <script type="application/ld+json">
                    {`
    {
      "@context": "https://schema.org",
      "@type": "Service",
      "serviceType": "Vastu Construction Services",
      "provider": {
        "@type": "LocalBusiness",
      ...
      "description": "Vastu-compliant construction services ensuring harmony and positive energy in residential and commercial buildings.",
      "offers": {
        "@type": "Offer",
        "offeredBy": {
          "@type": "Organization",
